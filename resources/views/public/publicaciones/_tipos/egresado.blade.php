...
<section class="relative pt-16">
    ...
    >
        <div class="absolute inset-0 bg-black/30 h-48 md:h-64 mt-16"></div>
    </div>

    {{-- Foto de perfil --}}
    <div class="max-w-6xl mx-auto px-6">
        <div class="relative -mt-16 md:-mt-20 mb-4 flex items-end gap-6">
            <img
                ...
                class="w-28 h-28 md:w-36 md:h-36 rounded-full object-cover ring-4 ring-white shadow-xl shrink-0"
            >
            <div class="pb-2">
                ...
                <table class="w-full text-sm">
                    @foreach($publicacion->metaDatos as $meta)
                        ...
                        <tr class="border-b border-gray-100 last:border-0">
                            <td class="px-4 py-3 font-bold text-primary align-top">{{ $meta->DATO_NOMBRE }}</td>
